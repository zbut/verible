...
// Tests that PortNameStructureRule correctly accepts valid names.
TEST(PortNameStructureRuleTest, AcceptTests) {
  ...
  RunLintTestCases<VerilogAnalyzer, PortNameStructureRule>(kTestCases);
}

// Tests that PortNameStructureRule rejects invalid names.
TEST(PortNameStructureRuleTest, RejectTests) {
