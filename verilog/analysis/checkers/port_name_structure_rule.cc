...
#include "verilog/analysis/checkers/port_name_structure_rule.h"
...
// Register PortNameStructureRule.
VERILOG_REGISTER_LINT_RULE(PortNameStructureRule);
...
const LintRuleDescriptor& PortNameStructureRule::GetDescriptor() {
...
void PortNameStructureRule::Violation(absl::string_view direction,
...
bool PortNameStructureRule::IsStructureCorrect(absl::string_view port_name) {
...
void PortNameStructureRule::HandleSymbol(const Symbol& symbol,
                                      const SyntaxTreeContext& context) {
...
LintRuleStatus PortNameStructureRule::Report() const {
